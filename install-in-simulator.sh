...
# delete everything in INSTALL_DIR_ROOT
rm -rf $INSTALL_DIR_ROOT/*

mkdir -p $INSTALL_DIR_ROOT/barnes
...
mkdir -p $INSTALL_DIR_ROOT/cholesky
...
mkdir -p $INSTALL_DIR_ROOT/fft
cp $BUILD_DIR/fft/FFT $INSTALL_DIR_ROOT/fft/FFT
cp $BUILD_DIR/fft/run.sh $INSTALL_DIR_ROOT/fft/run.sh

mkdir -p $INSTALL_DIR_ROOT/fmm
cp $BUILD_DIR/fmm/FMM $INSTALL_DIR_ROOT/fmm/FMM
cp $BUILD_DIR/fmm/run.sh $INSTALL_DIR_ROOT/fmm/run.sh
cp -R $BUILD_DIR/fmm/inputs $INSTALL_DIR_ROOT/fmm

mkdir -p $INSTALL_DIR_ROOT/lu_cb
cp $BUILD_DIR/lu_cb/LU-CONT $INSTALL_DIR_ROOT/lu_cb/LU-CONT
cp $BUILD_DIR/lu_cb/run.sh $INSTALL_DIR_ROOT/lu_cb/run.sh

mkdir -p $INSTALL_DIR_ROOT/lu_ncb
cp $BUILD_DIR/lu_ncb/LU-NOCONT $INSTALL_DIR_ROOT/lu_ncb/LU-NOCONT
cp $BUILD_DIR/lu_ncb/run.sh $INSTALL_DIR_ROOT/lu_ncb/run.sh

mkdir -p $INSTALL_DIR_ROOT/ocean_cp
...
mkdir -p $INSTALL_DIR_ROOT/ocean_ncp
...
mkdir -p $INSTALL_DIR_ROOT/raytrace
...
mkdir -p $INSTALL_DIR_ROOT/radiosity
